...
Console.WriteLine( "Result ="+ result);
 ...
 Console.WriteLine( "Total names ="+ namesCount);
    ...
    var selectstudent= from student in students where student.Contains('e') select student;
    foreach(string student in selectstudent){
   ...
   List<Product> pm = ProductManager.GetSoldOutProducts();
   foreach(Product p in pm){
    Console.WriteLine("Sold Product:"+p);
   }
